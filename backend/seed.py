...
departments_name = {
    "Cardiology Department", "Dermatology Department", "Endocrinology Department",
    "Gastroenterology Department", "Hematology Department", "Nephrology Department",
    "Neurology Department", "Oncology Department", "Ophthalmology Department",
    "Orthopedics Department", "Pediatrics Department", "Psychiatry Department",
    "Radiology Department", "Surgery Department"
}

medications_name = {
    "Amoxicillin", "Ibuprofen", "Lisinopril", "Metformin", "Simvastatin",
    "Omeprazole", "Levothyroxine", "Azithromycin", "Amlodipine", "Losartan",
    "Hydrochlorothiazide", "Atorvastatin", "Gabapentin", "Zolpidem",
    "Metoprolol", "Clopidogrel", "Montelukast", "Furosemide", "Pantoprazole",
    "Escitalopram", "Citalopram", "Sertraline", "Prednisone", "Tramadol",
    "Cyclobenzaprine", "Ciprofloxacin", "Doxycycline", "Meloxicam",
    "Oxycodone", "Hydroxychloroquine"
}

specialty_department_map = {specialty: f"{specialty} Department" for specialty in specialties}
...
def seed_data():
    with app.app_context():
        ...
        # Seed Departments
        departments = [Department(department_name=name) for name in departments_name]
        ...
        for _ in range(50):
            ...
            department_name = specialty_department_map[speciality]
        ...
        for _ in range(100):
            ...
            medical_records.append(MedicalRecord(patient_id=patient_id, medication_id=medication_id, diagnosis=diagnosis))
